...
/**
 * Handles a Supabase password-recovery link. The recovery email points
 * here with a `code` query parameter (per Supabase's PKCE recovery flow,
 * the same pattern the signup confirmation callback already uses) —
 * exchanging it establishes a session scoped to this recovery, which is
 * what makes `updateUser({ password })` below permitted at all.
 */
