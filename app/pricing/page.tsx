...
export const metadata: Metadata = {
  title: 'Plans & Pricing',
  description: 'Business Partner\u2019s Founding Customer offer: R199 per month, locked in for as long as your subscription stays active.',
 ...
 * 2026: the Founding Customer offer (R199/month, price locked for as
 * long as the subscription remains active, limited allocation) is the
 * only offer presented. R399/month becomes standard pricing once the
 * Founding Customer allocation closes and is deliberately not shown
 * here as a current option, per that same decision.
 *
    ...
    <div className="min-h-screen bg-surface">
      ...
      <main id="main-content" className="mx-auto max-w-[720px] px-5 py-16 md:px-8 md:py-24">
        ...
        <p className="mt-6 text-lg text-ink-soft">
          One plan, one straightforward price, while our Founding Customer offer remains open.
        </p>
        ...
        <div className="mt-10 rounded-lg border border-surface-border bg-surface-card p-8">
          ...
          <p className="mt-3 text-ink-soft">
            Locked in for as long as your subscription stays active. This is a limited launch
            offer for a limited number of customers. Once it closes, new customers join at our
            standard price.
          </p>
